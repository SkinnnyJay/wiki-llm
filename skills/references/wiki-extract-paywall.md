<!-- Full procedure for **wiki-extract-paywall**. Thin skill: `skills/wiki-extract-paywall/SKILL.md`. -->
...
Bypass tools and archives may violate **terms of service**, **copyright**, or **local law** for some sites or jurisdictions. The user and vault owner are responsible for **lawful, permitted** use: prefer official APIs, subscriptions, or openly licensed sources when available. This skill documents technical fallbacks only; it is **not** legal advice.
